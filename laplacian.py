...
class PhysicsInformedNN:
    ...
    def train(self,nIter):
        ...
        self.optimizer.minimize(self.sess,
                                feed_dict = tf_dict,
                                fetches = [self.loss, self.loss_u, self.loss_e],
...
if __name__ == "__main__":
    ...
    scipy.io.savemat('./figures/laplacian_Adam_%d_%s.mat' %(ID,time.strftime('%d_%m_%Y')),
                     {'u_pred':u_pred,
                      'a_pred':a_pred})   
    ...
    plt.savefig('./figures/orig_pitzsDaily.png')
